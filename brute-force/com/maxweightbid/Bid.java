...
public class Bid {
	...
	public class ItemforBid implements Comparable<ItemforBid>{
		
		public int id;
		public int bidprice;
		public int reserveprice = 0;
		
		public ItemforBid(int id, int bidprice)
		{
			this.id = id;
		...
		public ItemforBid(int intercept, int slope, int itemid, int quality,int reserveprice)
		{
			this.id = itemid;
			this.bidprice = intercept + (slope*quality);
			this.reserveprice = reserveprice;
		}
		
		@Override
		public int compareTo(ItemforBid other) {
			return  ((this.bidprice+other.reserveprice) < (other.bidprice+this.reserveprice) ? 1 : ((this.bidprice+other.reserveprice) > (other.bidprice+this.reserveprice)) ? -1 : 0);
		}
